...
When authenticating on dev-nodes through sesam-py you need to add your store name to the place-keeper for site_id in manifest.oauth and add site_id in your test-env file
